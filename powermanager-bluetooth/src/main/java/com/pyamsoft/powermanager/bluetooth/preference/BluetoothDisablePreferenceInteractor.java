...
class BluetoothDisablePreferenceInteractor extends CustomTimePreferenceInteractor <PowerManagerPreferences> {

  @Inject BluetoothDisablePreferenceInteractor(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
