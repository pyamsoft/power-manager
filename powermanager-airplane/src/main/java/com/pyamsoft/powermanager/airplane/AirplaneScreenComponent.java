...
@FragmentScope @Component(dependencies = PowerManagerComponent.class, modules = {
    ...
    AirplanePeriodPreferenceModule.class, StateModifierModule.class, StateObserverModule.class,
    PeriodicObserverModule.class, ManageObserverModule.class, PermissionObserverModule.class
}) interface AirplaneScreenComponent {

  void inject(AirplaneLoader loader);
