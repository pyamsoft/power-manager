...
@Module public class StateObserverModule {
  ...
  @Named("obs_wifi_state") @Provides BooleanInterestObserver provideWifiObserver(
  ...
  @Named("obs_charging_state") @Provides BooleanInterestObserver provideChargingObserver(
      @NonNull Context context) {
