...
class DataPreferenceLoader extends PreferenceLoader {

  @SuppressWarnings("WeakerAccess") @Inject @Named("data_custom_delay")
  ...
  DataPreferenceLoader() {
    DaggerDataPreferenceComponent.builder()
