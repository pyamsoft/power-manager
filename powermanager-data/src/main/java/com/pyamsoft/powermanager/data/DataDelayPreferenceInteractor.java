...
class DataDelayPreferenceInteractor extends CustomTimePreferenceInteractor<DataPreferences> {

  @Inject DataDelayPreferenceInteractor(@NonNull DataPreferences preferences) {
    super(preferences);
  }
