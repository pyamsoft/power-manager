...
class DataEnablePreferenceInteractor extends CustomTimePreferenceInteractor<DataPreferences> {

  @Inject DataEnablePreferenceInteractor(@NonNull DataPreferences preferences) {
    super(preferences);
  }
