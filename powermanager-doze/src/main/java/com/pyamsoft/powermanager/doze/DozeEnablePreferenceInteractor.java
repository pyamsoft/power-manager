...
class DozeEnablePreferenceInteractor extends CustomTimePreferenceInteractor<DozePreferences> {

  @Inject DozeEnablePreferenceInteractor(@NonNull DozePreferences preferences) {
    super(preferences);
  }
