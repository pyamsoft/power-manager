...
class DataPeriodPreferencePresenterImpl extends PeriodPreferencePresenterImpl {

  @Inject DataPeriodPreferencePresenterImpl(@NonNull PeriodPreferenceInteractor interactor,
