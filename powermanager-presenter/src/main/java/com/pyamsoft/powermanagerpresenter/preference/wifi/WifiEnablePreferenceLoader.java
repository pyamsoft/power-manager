...
public class WifiEnablePreferenceLoader extends PersistLoader<CustomTimeInputPreferencePresenter> {

  @SuppressWarnings("WeakerAccess") @Inject @Named("wifi_custom_enable")
