...
class WearManagePreferenceInteractorImpl extends ManagePreferenceInteractorImpl {

  @Inject WearManagePreferenceInteractorImpl(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
}
