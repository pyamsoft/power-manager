...
class SyncLoggerInteractor extends LoggerInteractorImpl {

  @NonNull private static final String LOG_ID = "SYNC";

  @Inject SyncLoggerInteractor(@NonNull Context context,
