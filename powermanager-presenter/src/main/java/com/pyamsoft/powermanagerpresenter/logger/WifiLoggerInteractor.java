...
class WifiLoggerInteractor extends LoggerInteractorImpl {

  @NonNull private static final String LOG_ID = "WIFI";

  @Inject WifiLoggerInteractor(@NonNull Context context,
