...
public class SyncManagePresenterLoader extends PersistLoader<ManagePreferencePresenter> {

  @SuppressWarnings("WeakerAccess") @Inject @Named("sync_manage_pref")
  Provider<ManagePreferencePresenter> presenterProvider;

  public SyncManagePresenterLoader() {
  }
