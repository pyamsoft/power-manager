...
class SyncManagePreferencePresenterImpl extends ManagePreferencePresenterImpl {

  @Inject SyncManagePreferencePresenterImpl(@NonNull ManagePreferenceInteractor manageInteractor,
