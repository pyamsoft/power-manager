...
class DataDisableTimePreferenceInteractorImpl extends CustomTimeInputPreferenceInteractorImpl {

  @Inject DataDisableTimePreferenceInteractorImpl(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
