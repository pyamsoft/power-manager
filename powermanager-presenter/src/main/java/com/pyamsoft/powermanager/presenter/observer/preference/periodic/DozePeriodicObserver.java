...
package com.pyamsoft.powermanager.presenter.observer.preference.periodic;
...
class DozePeriodicObserver extends BooleanPreferenceObserver {

  @Inject DozePeriodicObserver(@NonNull Context context,
      @NonNull PowerManagerPreferences preferences) {
    super(preferences, context.getString(R.string.periodic_doze_key));
  }
