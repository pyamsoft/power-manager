...
public class DozePeriodPresenterLoader extends PersistLoader<PeriodPreferencePresenter> {

  @SuppressWarnings("WeakerAccess") @Inject @Named("doze_period_pref")
  Provider<PeriodPreferencePresenter> presenterProvider;

  public DozePeriodPresenterLoader() {
  }
