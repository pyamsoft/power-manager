...
package com.pyamsoft.powermanager.presenter.observer.preference.manage;
...
class SyncManageObserver extends BooleanPreferenceObserver {

  @Inject SyncManageObserver(@NonNull Context context,
      @NonNull PowerManagerPreferences preferences) {
    super(preferences, context.getString(R.string.manage_sync_key));
  }
