...
class WifiDelayPreferenceInteractorImpl extends CustomTimeInputPreferenceInteractorImpl {

  @Inject WifiDelayPreferenceInteractorImpl(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
