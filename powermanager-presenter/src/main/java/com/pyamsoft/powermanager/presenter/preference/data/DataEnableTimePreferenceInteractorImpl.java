...
class DataEnableTimePreferenceInteractorImpl extends CustomTimeInputPreferenceInteractorImpl {

  @Inject DataEnableTimePreferenceInteractorImpl(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
