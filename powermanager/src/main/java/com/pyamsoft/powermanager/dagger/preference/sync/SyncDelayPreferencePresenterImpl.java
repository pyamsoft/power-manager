...
class SyncDelayPreferencePresenterImpl extends CustomTimeInputPreferencePresenterImpl {

  @Inject SyncDelayPreferencePresenterImpl(@Nullable CustomTimeInputPreferenceInteractor interactor,
