...
abstract class AppBarColoringSettingsFragment extends ActionBarSettingsPreferenceFragment {
  ...
  @CallSuper @Override public void onDestroyView() {
    super.onDestroyView();
    getMainActivity().colorAppBar(com.pyamsoft.powermanager.uicore.R.color.amber500,
        ANIMATION_TIME);
    getMainActivity().colorStatusBar(com.pyamsoft.powermanager.uicore.R.color.amber700,
        ANIMATION_TIME);
  }
