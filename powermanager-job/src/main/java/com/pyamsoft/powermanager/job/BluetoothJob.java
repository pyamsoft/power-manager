...
class BluetoothJob extends BaseJob {
  ...
  BluetoothJob(@NonNull Logger logger, @NonNull BooleanInterestObserver stateObserver,
  ...
  static class ManagedJob extends Job {
    ...
    @NonNull @Override protected Result onRunJob(Params params) {
      new BluetoothJob(logger, stateObserver, stateModifier) {
