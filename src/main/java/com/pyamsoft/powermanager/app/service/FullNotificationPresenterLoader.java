...
public class FullNotificationPresenterLoader extends PresenterLoader<FullNotificationPresenter> {
  ...
  @NonNull @Override protected FullNotificationPresenter loadPresenter() {
