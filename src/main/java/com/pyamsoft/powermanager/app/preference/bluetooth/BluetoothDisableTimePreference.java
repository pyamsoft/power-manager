...
public class BluetoothDisableTimePreference extends CustomTimeInputPreference {
  @Inject @Named("bluetooth_custom_disable") CustomTimeInputPreferencePresenter presenter;

  public BluetoothDisableTimePreference(Context context, AttributeSet attrs, int defStyleAttr,
      int defStyleRes) {
  ...
  public BluetoothDisableTimePreference(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public BluetoothDisableTimePreference(Context context) {
    super(context);
  }
