...
public final class ManagerPeriodicDisablePreference extends ManagerPeriodicPreference {
  ...
  @Override public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    setCustomHint("Custom Periodic Disable Time");
    setCustomSummary("Current disable time: %d seconds");
  }
}
