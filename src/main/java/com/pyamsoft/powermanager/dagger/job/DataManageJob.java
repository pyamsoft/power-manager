...
public abstract class DataManageJob extends ManageJob {
  ...
  DataManageJob(@NonNull JobManager jobManager, @NonNull JobType jobType, long delayInSeconds,
  ...
  public static final class DisableJob extends DataManageJob {
    ...
    public DisableJob(@NonNull JobManager jobManager, long delayTimeInMillis, boolean periodic,
        long periodicEnableInSeconds, long periodicDisableInSeconds) {
