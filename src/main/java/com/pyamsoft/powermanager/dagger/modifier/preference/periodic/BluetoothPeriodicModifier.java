...
package com.pyamsoft.powermanager.dagger.modifier.preference.periodic;
...
class BluetoothPeriodicModifier extends BooleanPreferenceModifier {

  @Inject BluetoothPeriodicModifier(@NonNull Context context,
