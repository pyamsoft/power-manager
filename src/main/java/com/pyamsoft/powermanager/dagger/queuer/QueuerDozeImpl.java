...
class QueuerDozeImpl extends QueuerImpl {
  ...
  @Inject QueuerDozeImpl(@NonNull Context context, @NonNull JobQueuerWrapper jobQueuerWrapper,
    ...
    super("DOZE", context, jobQueuerWrapper, handlerScheduler, stateObserver, stateModifier,
        chargingObserver, logger);
  }

  @NonNull @Override Intent getLongTermIntent(@NonNull Context context) {
    return new Intent(context.getApplicationContext(), QueuerDozeLongTermService.class);
  }
}
