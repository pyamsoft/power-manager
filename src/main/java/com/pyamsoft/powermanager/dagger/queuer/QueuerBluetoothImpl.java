...
class QueuerBluetoothImpl extends QueuerImpl {
  ...
  @Inject QueuerBluetoothImpl(@NonNull Context context, @NonNull JobQueuerWrapper jobQueuerWrapper,
    ...
    super("BLUETOOTH", context, jobQueuerWrapper, handlerScheduler, stateObserver, stateModifier,
