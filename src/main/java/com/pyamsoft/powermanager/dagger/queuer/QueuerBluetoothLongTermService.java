...
public class QueuerBluetoothLongTermService extends BaseLongTermService {
  ...
  public QueuerBluetoothLongTermService() {
    super(QueuerBluetoothLongTermService.class.getName());
  }
