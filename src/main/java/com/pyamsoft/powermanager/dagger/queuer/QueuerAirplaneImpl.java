...
class QueuerAirplaneImpl extends QueuerImpl {
  ...
  @Inject QueuerAirplaneImpl(@NonNull Context context, @NonNull JobQueuerWrapper jobQueuerWrapper,
    ...
    super("AIRPLANE", context, jobQueuerWrapper, handlerScheduler, stateObserver, stateModifier,
        chargingObserver, logger);
  }

  @NonNull @Override Intent getLongTermIntent(@NonNull Context context) {
    return new Intent(context.getApplicationContext(), QueuerAirplaneLongTermService.class);
  }
}
