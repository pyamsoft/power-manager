...
final class DataEnableTimePreferencePresenter extends CustomTimeInputPreferencePresenter {

  @Inject DataEnableTimePreferencePresenter(@Nullable CustomTimeInputPreferenceInteractor interactor,
