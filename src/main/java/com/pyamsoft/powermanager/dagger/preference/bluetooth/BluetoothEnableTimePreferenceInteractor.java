...
final class BluetoothEnableTimePreferenceInteractor extends CustomTimeInputPreferenceInteractorImpl {

  @Inject BluetoothEnableTimePreferenceInteractor(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
