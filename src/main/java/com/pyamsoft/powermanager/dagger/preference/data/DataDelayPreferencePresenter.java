...
final class DataDelayPreferencePresenter extends CustomTimeInputPreferencePresenterImpl {

  @Inject DataDelayPreferencePresenter(@Nullable CustomTimeInputPreferenceInteractor interactor,
