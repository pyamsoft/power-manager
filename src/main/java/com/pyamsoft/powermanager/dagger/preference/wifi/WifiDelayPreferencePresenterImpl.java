...
class WifiDelayPreferencePresenterImpl extends CustomTimeInputPreferencePresenterImpl {

  @Inject WifiDelayPreferencePresenterImpl(@Nullable CustomTimeInputPreferenceInteractor interactor,
