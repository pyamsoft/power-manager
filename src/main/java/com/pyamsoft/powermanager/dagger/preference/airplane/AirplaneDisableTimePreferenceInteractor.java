...
class AirplaneDisableTimePreferenceInteractor extends CustomTimeInputPreferenceInteractorImpl {

  @Inject AirplaneDisableTimePreferenceInteractor(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
