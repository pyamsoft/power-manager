...
class DataDelayPreferencePresenterImpl extends CustomTimeInputPreferencePresenterImpl {

  @Inject DataDelayPreferencePresenterImpl(@Nullable CustomTimeInputPreferenceInteractor interactor,
