...
final class BluetoothDisableTimePreferenceInteractor extends CustomTimeInputPreferenceInteractorImpl {

  @Inject BluetoothDisableTimePreferenceInteractor(@NonNull PowerManagerPreferences preferences) {
    super(preferences);
  }
