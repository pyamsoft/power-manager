...
abstract class ManagerSettingsInteractorImpl implements ManagerSettingsInteractor {
  ...
  @NonNull final String KEY_MANAGE_WIFI;
  @NonNull final String KEY_MANAGE_DATA;
  @NonNull final String KEY_MANAGE_BLUETOOTH;
  @NonNull final String KEY_MANAGE_SYNC;

  ManagerSettingsInteractorImpl(@NonNull Context context,
