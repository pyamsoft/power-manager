...
internal class DataSaverManageInteractor @Inject internal constructor(
  ...
  override val isManaged: Single<Pair<Boolean, Boolean>>
    get() = Single.fromCallable {
      return@fromCallable Pair(permissionObserver.hasPermission(), preferences.dataSaverManaged)
    }
}
